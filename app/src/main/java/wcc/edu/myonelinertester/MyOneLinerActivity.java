package wcc.edu.myonelinertester;
...
public class MyOneLinerActivity extends Activity implements OnClickListener{
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                if ((event.getAction() == KeyEvent.ACTION_DOWN) &&
                    ...
                    try
                    {
                        ...
                        Intent intent = new Intent("edu.wcc.oneliner.ACTION");
        ...
        switch (v.getId())
        {
            case R.id.pick:
                intent = new Intent(Intent.ACTION_PICK,
                        Uri.parse("content:///edu.wcc.oneliner"));
                startActivityForResult(intent, CMD_PICK);
                break;
            case R.id.random:
                intent = new Intent("edu.wcc.random_oneliner.ACTION");
                startActivityForResult(intent, CMD_RANDOM);
                break;
            case R.id.size:
                intent = new Intent("edu.wcc.oneliner.ACTION");
